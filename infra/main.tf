...
locals {
  function_get_note= "get-note-30112955"
  function_delete_note  = "delete-note-30112955"
  function_save_note = "save-note-30112955"
...
resource "aws_lambda_function" "delete_note_lambda" {
  ...
  source_code_hash = data.archive_file.lambda_zip_delete_note.output_base64sha256  #_base64sha256
...
resource "aws_lambda_function" "save_note_lambda" {
  ...
  source_code_hash = data.archive_file.lambda_zip_save_note.output_base64sha256  #_base64sha256
...
resource "aws_iam_policy" "get_note_logs" {
  ...
  description = "IAM policy for logging from a lambda for get notes"
